...
#sda
        self.submitBtn = ctk.CTkButton(self.headerFrame, text="Search", width=250, command=self.see_temp , fg_color="white" , text_color="black" , hover_color="gray"  )
    ...
    def see_temp(self):
        ...
        self.frameOptions.grid(row=1, column=0, pady=15)
        ...
        self.labelWind.grid(row=0, column=0, padx=10, sticky = "nsew")

        # ------------------------------------------------------------------------------------------
        self.frameHumity = ctk.CTkFrame(self.center, fg_color="steelblue")
        self.frameHumity.grid(row=2, column=0, pady=10, sticky="nsew", padx=370)
